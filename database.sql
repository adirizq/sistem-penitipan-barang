...
-- Dumping data for table sistem_penitipan_barang.locker: ~0 rows (approximately)
DELETE FROM `locker`;
...
CREATE TABLE IF NOT EXISTS `penyewaan` (
  ...
  `kelebihan_pinjam` date NOT NULL,
  KEY `penyewaan_locker_fk` (`id_locker`),
  CONSTRAINT `penyewaan_locker_fk` FOREIGN KEY (`id_locker`) REFERENCES `locker` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
sistem_penitipan_baranglockersistem_penitipan_barang